...
namespace StockManager.Database.Source.Migrations
{
    ...
    [Migration("20200923192743_Change_AppSettingsTable_Add_DocumentsFolder_Column")]
    partial class Change_AppSettingsTable_Add_DocumentsFolder_Column
    {
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppSettingsId = 1,
                            CreatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 437, DateTimeKind.Utc).AddTicks(3222),
                            DefaultGlobalMinStock = 0f,
                            DocumentsFolder = "Desktop",
                            Language = "pt-PT",
                            UpdatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 438, DateTimeKind.Utc).AddTicks(3213)
                        });
                });
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LocationId = 1,
                            CreatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 481, DateTimeKind.Utc).AddTicks(2970),
                            IsMain = true,
                            Name = "Warehouse",
                            UpdatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 481, DateTimeKind.Utc).AddTicks(2970)
                        },
                        new
                        {
                            LocationId = 2,
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            Code = "Admin",
                            CreatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 489, DateTimeKind.Utc).AddTicks(2925),
                            UpdatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 489, DateTimeKind.Utc).AddTicks(2925)
                        },
                        new
                        {
                            RoleId = 2,
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 601, DateTimeKind.Utc).AddTicks(2280),
                            Password = "$2b$10$PcqUaiX0rRfvloQjl429puel9qqXjUZi9iSlNH9NeQoRMM51yEz1O",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2020, 9, 23, 19, 27, 42, 601, DateTimeKind.Utc).AddTicks(2280),
                            Username = "Admin"
                        });
                });
