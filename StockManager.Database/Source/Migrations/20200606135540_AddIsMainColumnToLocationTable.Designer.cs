...
namespace StockManager.Database.Source.Migrations
{
    ...
    [Migration("20200606135540_AddIsMainColumnToLocationTable")]
    partial class AddIsMainColumnToLocationTable
    {
            ...
            modelBuilder.Entity("StockManager.Database.Source.Models.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppSettingsId = 1,
                            CreatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 673, DateTimeKind.Utc).AddTicks(647),
                            Language = "pt-PT",
                            UpdatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 673, DateTimeKind.Utc).AddTicks(647)
                        });
                });
            ...
            modelBuilder.Entity("StockManager.Database.Source.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LocationId = 1,
                            CreatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 835, DateTimeKind.Utc).AddTicks(1358),
                            IsMain = true,
                            Name = "Warehouse",
                            UpdatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 835, DateTimeKind.Utc).AddTicks(1358)
                        },
                        new
                        {
                            LocationId = 2,
            ...
            modelBuilder.Entity("StockManager.Database.Source.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            Code = "Admin",
                            CreatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 698, DateTimeKind.Utc).AddTicks(4493),
                            UpdatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 698, DateTimeKind.Utc).AddTicks(4493)
                        },
                        new
                        {
                            RoleId = 2,
            ...
            modelBuilder.Entity("StockManager.Database.Source.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 814, DateTimeKind.Utc).AddTicks(6330),
                            Password = "$2b$10$/srMc8L3u2TpGJhypk8K.Ov3sEduy75Oa/Z.1mw2.o/NKlHfA6p0S",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2020, 6, 6, 13, 55, 39, 814, DateTimeKind.Utc).AddTicks(6330),
                            Username = "Admin"
                        });
                });
