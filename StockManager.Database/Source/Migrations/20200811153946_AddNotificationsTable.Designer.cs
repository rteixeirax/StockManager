...
namespace StockManager.Database.Source.Migrations
{
    ...
    [Migration("20200811153946_AddNotificationsTable")]
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.AppSettings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppSettingsId = 1,
                            CreatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 182, DateTimeKind.Utc).AddTicks(8875),
                            Language = "pt-PT",
                            UpdatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 182, DateTimeKind.Utc).AddTicks(8875)
                        });
                });
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LocationId = 1,
                            CreatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 324, DateTimeKind.Utc).AddTicks(3390),
                            IsMain = true,
                            Name = "Warehouse",
                            UpdatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 324, DateTimeKind.Utc).AddTicks(3390)
                        },
                        new
                        {
                            LocationId = 2,
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            Code = "Admin",
                            CreatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 208, DateTimeKind.Utc).AddTicks(1546),
                            UpdatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 208, DateTimeKind.Utc).AddTicks(1546)
                        },
                        new
                        {
                            RoleId = 2,
            ...
            modelBuilder.Entity("StockManager.Core.Source.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 305, DateTimeKind.Utc).AddTicks(7878),
                            Password = "$2b$10$9S2AI8hOTmBAWHu9OJIuY.zVL.wn55Ql9pm5lZWUQ8rYujxmLnsGO",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2020, 8, 11, 15, 39, 45, 305, DateTimeKind.Utc).AddTicks(7878),
                            Username = "Admin"
                        });
                });
